...
import com.jefisu.jwtauthktorandroid.ui.MainViewModel
import com.jefisu.jwtauthktorandroid.ui.destinations.AuthScreenDestination
import com.jefisu.jwtauthktorandroid.ui.destinations.SecretScreenDestination
        ...
        viewModel.authResults.collect { result ->
            when (result) {
                is AuthResult.Authorized -> {
                    navigator.navigate(SecretScreenDestination(result.message)) {
